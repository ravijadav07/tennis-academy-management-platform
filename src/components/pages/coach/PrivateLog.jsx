        ...
        <div className="fixed inset-0 z-[310] flex items-center justify-center bg-black/30 backdrop-blur-sm" onClick={() => setShowNew(false)}>
          <div className="bg-white rounded-2xl p-5 w-full max-w-sm m-4 shadow-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-[10px] font-semibold text-ink-muted uppercase tracking-[0.04em] mb-1">Start Time (24h)</label>
                <input type="time" value={newTime} onChange={(e) => setNewTime(e.target.value)}
                  className="w-full h-[38px] px-3 rounded-lg border border-line text-[13px] outline-none focus:ring-2 focus:ring-brand/10 focus:border-brand" />
              </div>
              <div>
