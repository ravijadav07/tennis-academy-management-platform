      ...
      <Card className="p-3 sm:p-4">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 pb-2 border-b border-line">
            <div className="flex items-center gap-1 sm:gap-1.5 p-1 bg-canvas-soft rounded-lg flex-wrap">
              <button
                type="button"
              ...
              {selected.size > 0 && (
                <>
                  {selectedPendingCount > 0 && (
                    <Button size="sm" icon={CheckCircle} className="whitespace-nowrap" onClick={handleVerifySelected}>
                      Verify Selected ({selectedPendingCount})
                    </Button>
                  )}
                  {selectedCompletedCount > 0 && (
                    <Button size="sm" variant="secondary" icon={Undo2} className="whitespace-nowrap" onClick={handleUnverifySelected}>
          ...
          <div className="flex items-center justify-between flex-wrap gap-2.5">
              ...
              <div className="flex items-center gap-1.5 text-xs text-ink-muted flex-wrap">
                ...
                {(dateFrom || dateTo || coachFilter || searchQuery) && (
                  <Button
                    variant="ghost"
                    size="sm"
                    className="!h-[32px] !px-2 text-xs text-brand flex-shrink-0"
                    onClick={() => {
                      setDateFrom('');
                      setDateTo('');
                      setCoachFilter('');
            ...
            {filteredSessions.length > 0 && (
              <Button variant="ghost" size="sm" onClick={toggleSelectAll} className="text-xs whitespace-nowrap">
        ...
        byCoach.map(({ coachId, coachName, designation, sessions, count, pendingCount: groupPending, completedCount: groupCompleted }) => {
          ...
          return (
            <Card key={coachId} className="transition-all">
              {/* Coach Group Header */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 pb-2.5 border-b border-line gap-2">
                ...
                <div className="flex items-center gap-2 flex-wrap self-start sm:self-auto">
                  {groupPending > 0 && (
                    <Button
                      ...
                      className="!h-[28px] !text-[11px] whitespace-nowrap"
                    >
              ...
              {/* Sessions List - Adaptive Stack for Mobile / Tablet / Split screen */}
              <div className="space-y-2">
                {sessions.map((s) => {
                  ...
                  return (
                    <div
                      key={s.id}
                      className={`p-2.5 sm:px-3 sm:py-2.5 rounded-lg text-xs transition-colors border ${
                        isChecked
                    ...
                    >
                      ...
                      <div className="hidden md:flex items-center gap-3">
                        <input
                          ...
                          className="rounded text-brand focus:ring-brand cursor-pointer flex-shrink-0"
                        />
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          {isPending ? (
                            <Button
                              ...
                              className="!h-[28px] !px-2.5 !text-[11px] whitespace-nowrap"
                            >
                              Verify
                            </Button>
                          ) : (
                            <Button
                              ...
                              className="!h-[28px] !px-2 !text-[11px] text-ink-muted hover:text-ink whitespace-nowrap"
                      ...
                      <div className="flex md:hidden flex-col gap-2">
                        ...
                        <div className="flex items-center justify-between text-[11px] text-ink-muted pl-6 pt-0.5 flex-wrap gap-1.5">
                          ...
                          <div className="flex items-center gap-1.5 ml-auto">
                            {isPending ? (
                              ...
                              <Button
                                ...
                                disabled={isProcessing}
                                onClick={() => handleUnverifySingle(s.id)}
                                className="!h-[26px] !px-2 !text-[11px] text-ink-muted hover:text-ink"
                              >
                                Revert
                              </Button>
                            )}
